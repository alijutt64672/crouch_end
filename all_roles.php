                                                ...
                                                <tbody>
                                                    <?php while($row=mysqli_fetch_array($roles)){ $counter++  ?>
                                                        <tr>
                                                            ...
                                                            <td><center><a class="btn btn-outline-danger btn-sm waves-effect waves-light" href="delete_role.php?id=<?php echo $row["id"]; ?>"><i class="mdi mdi-account-off"></i></a></center></td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
